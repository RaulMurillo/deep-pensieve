...
f_name = './data/CIFAR10/posit32.ckpt'
...
results_path = './train_results/CIFAR10/'
...
if(send_mail):
    ...
    body = f'The Inference phase with data type {posit_t} on TensorFlow (CIFAR10 + Quire) has finished after {h} h, {m} min, {s} sec!\n\nThe ACC and Top-5 are:\n{hist}'
